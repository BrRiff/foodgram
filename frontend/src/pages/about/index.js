      ...
      <div className={styles.content}>
          <div>
            ...
            <div className={styles.text}>
              ...
              <p className={styles.textItem}>
                Проект разработан в рамках спринта обучения на курсе Яндекс Практикума по направлению «Python-разработчик Plus». Он сочетает в себе полный стек современных технологий: Django, PostgreSQL, Docker, GitHub Actions.
              </p>
              <p className={styles.textItem}>
